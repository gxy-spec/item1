...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--csv", type=str, default="rl/results/training_metrics.csv", help="Path to the training metrics CSV file")
    parser.add_argument("--output-dir", type=str, default="rl/plots", help="Directory to save generated plots")
...
def plot_training_curves(csv_path: str | Path, output_dir: str | Path = "rl/plots", prefix: str | None = None) -> Path:
