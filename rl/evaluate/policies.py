...
from rl.baselines import run_policy_episode
from rl.envs import AoIEnvConfig, SingleUAVAoIEnv
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate baselines and DQN on the AoI-energy environment")
    ...
    parser.add_argument("--output-dir", type=str, default="rl/outputs/evaluation")
